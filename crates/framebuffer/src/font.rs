//! # Simple Framebuffer Font
//!
//! A bitmap array of ASCII characters used for
//! [`crate::Framebuffer::draw_ascii_char`].

pub const CHAR_WIDTH: usize = 9;
pub const CHAR_HEIGHT: usize = 16;

// Copied from: https://github.com/torvalds/linux/blob/bce7f793daec3e65ec5c5705d2457b81fe7b5725/arch/ppc/boot/include/iso_font.h
pub const BASIC_FONT: [[u8; CHAR_HEIGHT]; 256] = [
    [
