...
const fn from_raw(num: i32) -> Error {
    ...
    match num {
        constants::EPERM => PERM,
        constants::ENOENT => NOENT,
        constants::ESRCH => SRCH,
        constants::EINTR => INTR,
        constants::EIO => IO,
        constants::ENXIO => NXIO,
        constants::E2BIG => E2BIG,
        constants::ENOEXEC => NOEXEC,
        constants::EBADF => BADF,
        constants::ECHILD => CHILD,
        constants::EAGAIN => AGAIN,
        constants::ENOMEM => NOMEM,
        constants::EACCES => ACCES,
        constants::EFAULT => FAULT,
        constants::ENOTBLK => NOTBLK,
        constants::EBUSY => BUSY,
        constants::EEXIST => EXIST,
        constants::EXDEV => XDEV,
        constants::ENODEV => NODEV,
        constants::ENOTDIR => NOTDIR,
        constants::EISDIR => ISDIR,
        constants::EINVAL => INVAL,
        constants::ENFILE => NFILE,
        constants::EMFILE => MFILE,
        constants::ENOTTY => NOTTY,
        constants::ETXTBSY => TXTBSY,
        constants::EFBIG => FBIG,
        constants::ENOSPC => NOSPC,
        constants::ESPIPE => SPIPE,
        constants::EROFS => ROFS,
        constants::EMLINK => MLINK,
        constants::EPIPE => PIPE,
        constants::EDOM => DOM,
        constants::ERANGE => RANGE,
        constants::EDEADLK => DEADLK,
        constants::ENAMETOOLONG => NAMETOOLONG,
        constants::ENOLCK => NOLCK,
        constants::ENOSYS => NOSYS,
        constants::ENOTEMPTY => NOTEMPTY,
        constants::ELOOP => LOOP,
        constants::ENOMSG => NOMSG,
        constants::EIDRM => IDRM,
        constants::ECHRNG => CHRNG,
        constants::EL2NSYNC => L2NSYNC,
        constants::EL3HLT => L3HLT,
        constants::EL3RST => L3RST,
        constants::ELNRNG => LNRNG,
        constants::EUNATCH => UNATCH,
        constants::ENOCSI => NOCSI,
        constants::EL2HLT => L2HLT,
        constants::EBADE => BADE,
        constants::EBADR => BADR,
        constants::EXFULL => XFULL,
        constants::ENOANO => NOANO,
        constants::EBADRQC => BADRQC,
        constants::EBADSLT => BADSLT,
        constants::EBFONT => BFONT,
        constants::ENOSTR => NOSTR,
        constants::ENODATA => NODATA,
        constants::ETIME => TIME,
        constants::ENOSR => NOSR,
        constants::ENONET => NONET,
        constants::ENOPKG => NOPKG,
        constants::EREMOTE => REMOTE,
        constants::ENOLINK => NOLINK,
        constants::EADV => ADV,
        constants::ESRMNT => SRMNT,
        constants::ECOMM => COMM,
        constants::EPROTO => PROTO,
        constants::EMULTIHOP => MULTIHOP,
        constants::EDOTDOT => DOTDOT,
        constants::EBADMSG => BADMSG,
        constants::EOVERFLOW => OVERFLOW,
        constants::ENOTUNIQ => NOTUNIQ,
        constants::EBADFD => BADFD,
        constants::EREMCHG => REMCHG,
        constants::ELIBACC => LIBACC,
        constants::ELIBBAD => LIBBAD,
        constants::ELIBSCN => LIBSCN,
        constants::ELIBMAX => LIBMAX,
        constants::ELIBEXEC => LIBEXEC,
        constants::EILSEQ => ILSEQ,
        constants::ERESTART => RESTART,
        constants::ESTRPIPE => STRPIPE,
        constants::EUSERS => USERS,
        constants::ENOTSOCK => NOTSOCK,
        constants::EDESTADDRREQ => DESTADDRREQ,
        constants::EMSGSIZE => MSGSIZE,
        constants::EPROTOTYPE => PROTOTYPE,
        constants::ENOPROTOOPT => NOPROTOOPT,
        constants::EPROTONOSUPPORT => PROTONOSUPPORT,
        constants::ESOCKTNOSUPPORT => SOCKTNOSUPPORT,
        constants::EOPNOTSUPP => OPNOTSUPP,
        constants::EPFNOSUPPORT => PFNOSUPPORT,
        constants::EAFNOSUPPORT => AFNOSUPPORT,
        constants::EADDRINUSE => ADDRINUSE,
        constants::EADDRNOTAVAIL => ADDRNOTAVAIL,
        constants::ENETDOWN => NETDOWN,
        constants::ENETUNREACH => NETUNREACH,
        constants::ENETRESET => NETRESET,
        constants::ECONNABORTED => CONNABORTED,
        constants::ECONNRESET => CONNRESET,
        constants::ENOBUFS => NOBUFS,
        constants::EISCONN => ISCONN,
        constants::ENOTCONN => NOTCONN,
        constants::ESHUTDOWN => SHUTDOWN,
        constants::ETOOMANYREFS => TOOMANYREFS,
        constants::ETIMEDOUT => TIMEDOUT,
        constants::ECONNREFUSED => CONNREFUSED,
        constants::EHOSTDOWN => HOSTDOWN,
        constants::EHOSTUNREACH => HOSTUNREACH,
        constants::EALREADY => ALREADY,
        constants::EINPROGRESS => INPROGRESS,
        constants::ESTALE => STALE,
        constants::EUCLEAN => UCLEAN,
        constants::ENOTNAM => NOTNAM,
        constants::ENAVAIL => NAVAIL,
        constants::EISNAM => ISNAM,
        constants::EREMOTEIO => REMOTEIO,
        constants::EDQUOT => DQUOT,
        constants::ENOMEDIUM => NOMEDIUM,
        constants::EMEDIUMTYPE => MEDIUMTYPE,
        constants::ECANCELED => CANCELED,
        constants::ENOKEY => NOKEY,
        constants::EKEYEXPIRED => KEYEXPIRED,
        constants::EKEYREVOKED => KEYREVOKED,
        constants::EKEYREJECTED => KEYREJECTED,
        constants::EOWNERDEAD => OWNERDEAD,
        constants::ENOTRECOVERABLE => NOTRECOVERABLE,
        constants::ERFKILL => RFKILL,
        constants::EHWPOISON => HWPOISON,
        _ => NULL,
    }
}
